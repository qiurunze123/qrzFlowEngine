...
@Component
@Slf4j
public class CompanyNodeOne implements SComponent<SContext> {

    protected final static String supportAction = "CompanyNodeOne";
    ...
    public void process(SContext input) {
        ...
        String companyName = supplierContext.getCompanyName();
